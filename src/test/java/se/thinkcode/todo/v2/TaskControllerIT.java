...
public class TaskControllerIT {
    ...
    private void createTask() {
        ...
        CreateTaskRequest createTaskRequest = new CreateTaskRequest("Max", "Öva");
        ClientResponseTyped<CreateTaskRequest> response = request.submit(createTaskRequest, CreateTaskRequest.class);
